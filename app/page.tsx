...
const DeveloperSuite = () => {
  ...
  // Define the default metadata object
  const defaultMetadata = {
    "674": {
      "msg": [
        "Payment for invoice #1234.",
        "Thanks from the Cardano Dev Suite team!"
      ]
    }
  };
  // ... inside your DeveloperSuite component
    ...
    <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
      ...
      <div className="bg-slate-900 border border-slate-700 rounded-2xl p-6">
          ...
          <div className="mt-6">
            ...
            {activeTab === 'Contract' && (
              <div className="text-slate-400 text-center py-8">V2 Feature Coming Soon...</div>
            )}
          </div>
      </div>
...
// ... (Your other sub-components like CustomWalletConnector, TabButton, etc. remain the same) ...
// --- Sub-Components ---
